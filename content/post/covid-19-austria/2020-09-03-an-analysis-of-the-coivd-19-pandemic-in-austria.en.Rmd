...
The World Health Organization (WHO) declared the COVID-19 outbreak as a pandemic on March 11, 2020. COVID-19 first reported in December 2019 in Wuhan China, is a respiratory disease caused by a new form of the coronavirus. With no confirmed treatment, and the rate of spread across the world, COVID-19 has impacted almost all countries across the world, with Austria being no exception.
...
The database of daily COVID-19 cases, deaths and recoveries in the countries belonging to the European Union Civil Protection Mechanism (UCPM) maintained by the  European Commission Joint Research Centre (JRC) is used within the analysis of the COVID-19 pandemic in Austria. The population of the Austrian states as at January 2020 is extracted from wikipedia.
...
The trend in COVID-19 since early 2020 upto around March is quite a sudden increase, thereafter the rate of increase suddenly plateaus in around May. The rate of increate is much lower from May to July and thereafter increases again. This may be an effect of the social distancing restrictions being eased in Austria.
